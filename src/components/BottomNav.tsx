...
const BottomNav = ({ active = "shop"}: BottomNavProps) => {
      const navigate = useNavigate();

  return (
    <div className="fixed bottom-0 left-0 right-0 h-[92px] bg-white flex items-center justify-around px-2 z-10 shadow-[2px_-5px_15px_0px_#555E5817]">
      {tabs.map(({ id, label, Icon, route }) => {
        ...
        return (
          <button
            ...
            className="flex flex-col items-center gap-1 w-[72px] cursor-pointer"
          >
