...
export const ShopIcon = ({ active }: IconProps) => {
  const c = active ? A : C;
  return (
...
export const ExploreIcon = ({ active }: IconProps) => {
  const c = active ? A : C;
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
...
export const CartIcon = ({ active }: IconProps) => {
  const c = active ? A : C;
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
...
export const FavouriteIcon = ({ active }: IconProps) => {
  const c = active ? A : C;
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path
...
export const AccountIcon = ({ active }: IconProps) => {
  const c = active ? A : C;
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
