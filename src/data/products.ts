...
export const groceryCategories = [
    { id: 7, name: "Pulses", bg: "bg-[#FFF3E5]", image: pulses },
    { id: 8, name: "Rice", bg: "bg-[#E5F5E5]", image: Rice },
];
...
export const exploreCategories = [
    { id: 12, name: "Fresh Fruits & Vegetable", image: freshfruits, bg: "bg-[#E8F5E9]", border: "border-[#D4EDDA]" },
    { id: 13, name: "Cooking Oil & Ghee", image: cookingoil, bg: "bg-[#FFF8E1]", border: "border-[#FFE082]" },
    { id: 14, name: "Meat & Fish", image: meatfish, bg: "bg-[#FCE4EC]", border: "border-[#F8BBD0]" },
    { id: 15, name: "Bakery & Snacks", image: bakery, bg: "bg-[#FFF3E0]", border: "border-[#FFE0B2]" },
    { id: 16, name: "Beverages", image: beverages, bg: "bg-[#E3F2FD]", border: "border-[#BBDEFB]" },
    { id: 17, name: "Cooking Oil Bottles", image: cookingoilbottles, bg: "bg-[#FFF8E1]", border: "border-[#FFE082]" },
    { id: 18, name: "Cooking Oil & Ghee", image: cookingoil, bg: "bg-[#FFF8E1]", border: "border-[#FFE082]" },
    { id: 19, name: "Dairy & Fish", image: dairyFish, bg: "bg-[#E0F7FA]", border: "border-[#B2EBF2]" },
];