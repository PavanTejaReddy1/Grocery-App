        ...
        <div className="w-1/2 bg-white flex items-center justify-center px-16">
          <div className="w-full max-w-[460px]">
            ...
            <button
              type="button"
              onClick={() => navigate("/number")}
              className="h-[60px] w-full rounded-[19px] bg-[#5383EC] text-white font-semibold transition hover:opacity-90 mb-4 cursor-pointer"
            >
              Continue with Google
            </button>
            <button
              onClick={() => navigate("/number")}
              type="button"
              className="h-[60px] w-full rounded-[19px] bg-[#4A66AC] text-white font-semibold transition hover:opacity-90 cursor-pointer"
            >
              Continue with Facebook
            </button>

            <p className="text-center text-[13px] text-[#828282] mt-6 cursor-pointer">
