        ...
        <div className="relative flex flex-col mt-auto">
          ...
          <div className="absolute right-5 top-[-54px] z-10">
            <button
              ...
              disabled={!isReady}
              className={`w-12 h-12 rounded-full flex items-center justify-center shadow-lg transition-colors ${isReady ? "bg-green-600 hover:bg-green-600" : "bg-green-200 cursor-not-allowed"
                }`}
            >
