                        ...
                        <div className="grid grid-cols-2 gap-4 p-4">
                            {filteredProducts.map((item) => (
                                <div
                                    ...
                                    className="border border-[#E2E2E2] rounded-[18px] p-3 cursor-pointer"
                                >
                                    <img
                                        src={item.image}
                                        alt={item.name}
                                        className="w-[80px] h-[120px] mx-auto object-contain"
                                    />
                                    ...
                                    <div className="flex justify-between items-center mt-2">
                                        ...
                                        <button className="w-[28px] h-[28px] bg-[#53B175] rounded-full text-white">
                                            +
                                        </button>
                                    </div>
                                </div>
